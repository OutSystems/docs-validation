...
* *Concept* -  can introduces a topic, identifies and audience, explains what this thing is and how it benefits the reader.

* *Process* - is a series of steps (that are interdependent) that readers follow to complete a task. Process diagrams help users to understand how the parts fit together. The overall picture. 

* *Procedure* - is a way of doing something to complete a task. THese steps must be followed in the order specified.  Screenshots are used to help explain the sequence of steps readers  follow to reach the goal.  
