...
Begin the document with an introduction / overivew to let readers know what to expect in the document and it confirms they found what they were looking for. 
...
Only use adminitions (infoboxes, warnings, errors) when you need to emphasize a piece of information. The overuse of adminitions has the opposite effect, as readers start ignoring them. 
