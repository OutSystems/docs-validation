...
Yes: This feature has the following limitations. For more information about the updates, refer to the Release notes.

No: This feature has the following limitations that will be removed next month, in version 11.9.
