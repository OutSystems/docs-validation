...
Unfortunately, some readers ignore any information that appears in parentheses, so don't put important information in parentheses.

Whenever you're inclined to use parentheses, consider whether they're necessary. Maybe the sentence or paragraph might work just as well if you remove the parentheses and set off the phrase or sentence by using commas, dashes, or periods.
